...
client.login('NzQzODY5MDI5NjM4NDcxODAy.Xza8BQ.ufnJH76bemAATBg0kqeYDWF5Cjc');
...
//An about announcement for everyone but no one knows so fine ^w^
  if(message.content.startsWith(`${prefix}about`)){
    ...
    .setColor("YELLOW")
    .setAuthor("About Zooya Bot.", "https://cdn.discordapp.com/attachments/811603759485550663/827830308846043166/PicsArt_03-22-02.43.02.jpg")
